...
@section("title",config("ayarlar.baslik")." Kayıt Ol")
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group row mb-0">
                        <div class="col-md-6 offset-md-4">
                            <button type="submit" class="btn btn-primary">{{ __('Kayıt Ol') }}</button>
                            <a class="btn btn-warning" href="{{ route('login') }}">{{ __('Giriş Yap') }}</a>
                        </div>
                    </div>
                </form>
            </div>
