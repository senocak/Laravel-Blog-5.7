...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="{{url('/')}}/css/{{ tema()  }}/w3.css">
		<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Raleway">
		<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
		<script src="{{url('/')}}/js/{{ tema()  }}/jquery.min.js"></script>
	...
	<body class="w3-light-grey w3-content" style="max-width:1600px">
		<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
			...
			<div class="w3-bar-block">
				<a href="/" class="w3-bar-item w3-button w3-padding <?php if(Request::segment(1)=="" or Request::segment(1)=="blog" or Request::segment(1)=="category")echo "w3-blue"; ?>"><i class="fa fa-th-large fa-fw w3-margin-right"></i>Anasayfa</a>
